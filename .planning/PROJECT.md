...
- [ ] 대시보드 UI — 에이전트별 상태/도구 사이드 패널
- [ ] 토큰/비용 추적 — API 사용량 실시간 모니터링
- [ ] 에셋 교체 — 새 에셋팩(PixelOffice/Pixel Life)으로 오피스 전면 교체
...
## Current Milestone: v1.2 Dashboard & Polish

**Goal:** UX 레이어 강화 — 대시보드 사이드 패널, 토큰 추적, 새 에셋팩으로 오피스 비주얼 업그레이드

**Target features:**
- 대시보드 UI (에이전트별 상태/도구 표시, 사이드 패널)
- 토큰/비용 추적 (API 사용량 실시간 모니터링)
- 에셋 교체 (PixelOffice/Pixel Life/office_assets_release로 전면 교체)
